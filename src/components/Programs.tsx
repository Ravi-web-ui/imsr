      ...
      <div className="w-full px-[30px] relative -mt-20 z-20">
        ...
        >
          {[...filteredPrograms, ...filteredPrograms].map((program, idx) => (
            <div
              key={idx}
              className={`program-card flex-shrink-0 w-[285px] sm:w-[320px] md:w-[calc((100%-24px)/2.25)] lg:w-[calc((100%-72px)/3.4)] ${program.bg} overflow-hidden hover:-translate-y-2 transition-all duration-350 flex flex-col`}
              style={{ 
            ...
            >
              ...
              <div className="p-7 flex flex-col justify-between flex-grow">
                   ...
                   <div className="flex items-start gap-2.5">
                     <div className="w-8 h-8 rounded-full border border-zinc-950/15 flex items-center justify-center flex-shrink-0 text-zinc-800">
                       <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                         ...
                         <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l4-2.2M12 14v6.5" />
                       </svg>
                     </div>
                     <div className="flex flex-col">
                ...
                <div className="flex justify-start mt-8">
                  <a 
                    href={`#explore-${idx}`}
                    className="px-6 py-2.5 rounded-full border border-zinc-800 hover:bg-zinc-800 hover:text-white transition-all duration-300 font-sans font-medium text-[13px] flex items-center gap-2 select-none cursor-pointer"
                  >
